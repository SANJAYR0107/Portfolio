...
export function HackerrankIcon({ size = 18, className = "", style = {} }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 0c1.285 0 9.75 4.886 10.392 6 .645 1.115.645 11.885 0 13-.642 1.114-9.107 6-10.392 6-1.285 0-9.75-4.886-10.392-6C.963 17.885.963 7.115 1.608 6 2.25 4.886 10.715 0 12 0zm2.295 6.799c-.141 0-.258.115-.258.258v1.5H9.963V6.799c0-.141-.115-.258-.258-.258H7.482c-.141 0-.258.115-.258.258v10.402c0 .141.115.258.258.258H9.705c.141 0 .258-.115.258-.258v-1.5h4.074v1.5c0 .141.115.258.258.258h2.223c.141 0 .258-.115.258-.258V6.799c0-.141-.115-.258-.258-.258z" />
    </svg>
  );
}
